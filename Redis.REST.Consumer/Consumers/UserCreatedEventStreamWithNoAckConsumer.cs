...
{
    public class UserCreatedEventStreamWithNoAckConsumer(RedisService redisService) : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            {
                var streamEntries =
                    db.StreamReadGroup(StreamName, GroupName, "consumer1", position: ">", count: 10, true);
